...
All values for $\Phi \not\in \{0,1\}$ for this system are given in Table~\ref{tab:brake-survsign}.
...
***we use box-constraint optimization via option \texttt{L-BFGS-B} of \texttt{optim} in \textsf{R}.
