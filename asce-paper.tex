...
For example, the prior probability of the system to survive until time $10$ is between $***$ and $***$.
...
from the prior assumptions, surviving past time 8 is already quite unusual.
